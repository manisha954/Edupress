...
// import { uploadFile } from "@/src/signInWithSupabase/SignInwithSupabase";
// import { validateAdmin } from "@/src/utils/validation/validateAdmin";
...
//         where: { footerId: footerId, companyId: user.specificId },
//       });
